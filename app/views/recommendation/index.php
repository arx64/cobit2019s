        ...
        <div class="card summary-card bg-primary text-white">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <h3 class="mb-0"><?php echo number_format($avgCapability, 2); ?></h3>
                        <p class="mb-0 opacity-75">Rata-rata Capability Level</p>
                    </div>
                </div>
            </div>
        </div>
...
<div id="chartsSection" class="row mb-4 no-print">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-bar-chart me-2"></i>Grafik Capability Level</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-pie-chart me-2"></i>Grafik Gap Analysis</h5>
            </div>
            <div class="card-body">
                <div class="chart-container">
...
const ctxCapability = document.getElementById('capabilityChart').getContext('2d');
new Chart(ctxCapability, {
    type: 'bar',
    data: {
        labels: chartLabels,
        datasets: [
...
const gapColors = chartGaps.map(gap => {
    if (gap <= 0) return 'rgba(25, 135, 84, 0.7)';
    if (gap <= 1) return 'rgba(13, 202, 240, 0.7)';
    if (gap <= 2) return 'rgba(255, 193, 7, 0.7)';
...
new Chart(ctxGap, {
    ...
    data: {
        ...
        datasets: [{
            ...
            borderColor: gapColors.map(c => c.replace('0.7', '1')),
            borderWidth: 1
        }]
    },
    options: {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Distribusi Gap per Proses'
            }
        }
    }
});
